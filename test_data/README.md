...
│   └── sample1_R2.fastq.gz
└── reference/
    ├── star_index/           # STAR index directory (not tarball for Python)
    │   ├── Genome
    │   ├── SA
    │   ├── SAindex
    │   ├── chrName.txt
...
- **STAR index**: ~500 MB - 2 GB (uncompressed directory)
- **GTF**: ~5-50 MB
...
- For Python pipeline, STAR index should be a directory, not a tarball
